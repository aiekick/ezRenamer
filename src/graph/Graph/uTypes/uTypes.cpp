...
namespace uType
{
	...
	*/
	...
	std::string ConvertUniformsTypeEnumToString(const uTypeEnum& vType)
	{
		...
		case uTypeEnum::U_FLOAT:					return "float";
		...
		case uTypeEnum::U_SAMPLER1D:				return "sampler1D";
		case uTypeEnum::U_SAMPLER1D_ARRAY:			return "sampler1D";
		case uTypeEnum::U_SAMPLER2D:				return "sampler2D";
		case uTypeEnum::U_SAMPLER2D_ARRAY:			return "sampler2D";
		case uTypeEnum::U_SAMPLER3D:				return "sampler3D";
		...
		case uTypeEnum::U_MAT4:						return "mat4";
	...
	{
		if (vType == "text")		    return uTypeEnum::U_TEXT;

		if (vIsArray)
		{
			if (vType == "mat4")		return uTypeEnum::U_MAT4_ARRAY;
			if (vType == "float")		return uTypeEnum::U_FLOAT_ARRAY;
			if (vType == "vec2")		return uTypeEnum::U_VEC2_ARRAY;
			if (vType == "vec3")		return uTypeEnum::U_VEC3_ARRAY;
			if (vType == "vec4")		return uTypeEnum::U_VEC4_ARRAY;
			if (vType == "int")			return uTypeEnum::U_INT_ARRAY;
			if (vType == "sampler1D")	return uTypeEnum::U_SAMPLER1D_ARRAY;
			if (vType == "sampler2D")	return uTypeEnum::U_SAMPLER2D_ARRAY;
			if (vType == "sampler3D")	return uTypeEnum::U_SAMPLER3D_ARRAY;
		}
		else
		{
			if (vType == "float")		return uTypeEnum::U_FLOAT;
			if (vType == "vec2")		return uTypeEnum::U_VEC2;
			if (vType == "vec3")		return uTypeEnum::U_VEC3;
			if (vType == "vec4")		return uTypeEnum::U_VEC4;
			if (vType == "int")			return uTypeEnum::U_INT;
			if (vType == "ivec2")		return uTypeEnum::U_IVEC2;
			if (vType == "ivec3")		return uTypeEnum::U_IVEC3;
			if (vType == "ivec4")		return uTypeEnum::U_IVEC4;
			if (vType == "uint")		return uTypeEnum::U_UINT;
			if (vType == "uvec2")		return uTypeEnum::U_UVEC2;
			if (vType == "uvec3")		return uTypeEnum::U_UVEC3;
			if (vType == "uvec4")		return uTypeEnum::U_UVEC4;
			if (vType == "bool")		return uTypeEnum::U_BOOL;
			if (vType == "bvec2")		return uTypeEnum::U_BVEC2;
			if (vType == "bvec3")		return uTypeEnum::U_BVEC3;
			if (vType == "bvec4")		return uTypeEnum::U_BVEC4;
			if (vType == "image1D")		return uTypeEnum::U_IMAGE1D;
			if (vType == "image2D")		return uTypeEnum::U_IMAGE2D;
			if (vType == "image3D")		return uTypeEnum::U_IMAGE3D;
			if (vType == "sampler1D")	return uTypeEnum::U_SAMPLER1D;
			if (vType == "sampler2D")	return uTypeEnum::U_SAMPLER2D;
			if (vType == "sampler3D")	return uTypeEnum::U_SAMPLER3D;
		}

		if (vType == "sampler2DArray")	return uTypeEnum::U_SAMPLER2D_TEXTUREARRAY;
		if (vType == "samplerCube")		return uTypeEnum::U_SAMPLERCUBE;
		if (vType == "mat2")			return uTypeEnum::U_MAT2;
		if (vType == "mat3")			return uTypeEnum::U_MAT3;
		if (vType == "mat4")			return uTypeEnum::U_MAT4;
		if (vType == "void")			return uTypeEnum::U_VOID;
		if (vType == "structure")		return uTypeEnum::U_STRUCT;
		if (vType == "bool")			return uTypeEnum::U_BOOL;
		if (vType == "bvec2")			return uTypeEnum::U_BVEC2;
		if (vType == "bvec3")			return uTypeEnum::U_BVEC3;
		if (vType == "bvec4")			return uTypeEnum::U_BVEC4;
		if (vType == "type")			return uTypeEnum::U_TYPE;
		if (vType == "vec")				return uTypeEnum::U_VEC;
		if (vType == "mat")				return uTypeEnum::U_MAT;
		if (vType == "flow")			return uTypeEnum::U_FLOW;
		if (vType == "program")			return uTypeEnum::U_PROGRAM;
		if (vType == "global")			return uTypeEnum::U_GLOBAL;
